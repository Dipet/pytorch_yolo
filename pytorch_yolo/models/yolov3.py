...
class YOLOv3(YOLOBase):
    def __init__(self, *args, **kwargs):
        ...
        self.seq.add_module(
            "conv2", ConvBlock(self.seq[-1].out_channels, 1024 // kd, 3)
        )
        self.seq.add_module("conv3", ConvBlock(self.seq[-1].out_channels, 512 // kd, 1))
        self.seq.add_module(
            "conv4", ConvBlock(self.seq[-1].out_channels, 1024 // kd, 3)
        )
        ...
        self.seqy2_2.add_module(
            "conv1",
            ConvBlock(
                self.seqy2_1[0].out_channels + self.down4.out_channels, 256 // kd, 1
            ),
        )
        self.seqy2_2.add_module(
            "conv2", ConvBlock(self.seqy2_2[-1].out_channels, 512 // kd)
        )
        self.seqy2_2.add_module(
            "conv3", ConvBlock(self.seqy2_2[-1].out_channels, 256 // kd, 1)
        )
        self.seqy2_2.add_module(
            "conv4", ConvBlock(self.seqy2_2[-1].out_channels, 512 // kd)
        )
        self.seqy2_2.add_module(
            "conv5", ConvBlock(self.seqy2_2[-1].out_channels, 256 // kd, 1)
        )
        ...
        self.seqy3_2.add_module(
            "conv1",
            ConvBlock(
                self.seqy3_1[0].out_channels + self.down3.out_channels, 128 // kd, 1
            ),
        )
        self.seqy3_2.add_module(
            "conv2", ConvBlock(self.seqy3_2[-1].out_channels, 256 // kd)
        )
        self.seqy3_2.add_module(
            "conv3", ConvBlock(self.seqy3_2[-1].out_channels, 128 // kd, 1)
        )
        self.seqy3_2.add_module(
            "conv4", ConvBlock(self.seqy3_2[-1].out_channels, 256 // kd)
        )
        self.seqy3_2.add_module(
            "conv5", ConvBlock(self.seqy3_2[-1].out_channels, 128 // kd, 1)
        )
        self.seqy3_2.add_module(
            "conv6", ConvBlock(self.seqy3_2[-1].out_channels, 256 // kd)
        )
        self.seqy3_2.add_module(
            "conv7",
