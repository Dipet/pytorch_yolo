...
class YOLOv3(YOLOBase):
    def __init__(self, *args, **kwargs):
        ...
        self.seqy2_2.add_module('conv1', ConvBlock(self.seqy2_1[0].out_channels + self.down4.out_channels, 256 // kd, 1))
        ...
        self.seqy3_2.add_module('conv1', ConvBlock(self.seqy3_1[0].out_channels + self.down3.out_channels, 128 // kd, 1))
...
if __name__ == '__main__':
    ...
    device = 'cuda'
    model = YOLOv3(n_class=80, onnx=False, in_shape=(1, 3, 320, 320),
